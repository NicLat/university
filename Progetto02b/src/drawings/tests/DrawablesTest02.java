...
public class DrawablesTest02 {
	...
	public static void main(String[] args) {
		DrawingsFrame frame = new DrawingsFrame(new CompositeDrawable(new Rectangle(10,10,50,50),new Rectangle(110,10,50,50),new Circle(200,200,50)));
		frame.launchFrame();
		
		
		Drawable[] drawables={	new Rectangle(10,10,50,50),
